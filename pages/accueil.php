...
<h1>SigaAnalyses</h1><a href="http://www.lorraine.nosterritoires.fr/analyse/pages/accueilgp.html" data-icon="bullets" data-transition="fade"   >Accueil</a>
</div>
		...
		$.ajax({
			...
			success : function(data){	
				...
				for(i=0;i<obj.length;i++){
					...
					buffer1=buffer1 + '<li><a href="./type.php?iddepartement='+ tmp[0] + '"  rel="external" >' + tmp[1] + '</a></li>';												
					}
				buffer1=buffer1 + '</ul>';
				$('#pri').html(buffer1);
				$('#pri').trigger('create');

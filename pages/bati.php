		...
		<fieldset data-role="fieldcontain"> 
			<ul data-role="listview" data-inset="true">
				<li data-role="fieldcontain">
					...
					<div>	
						<a href="#popupInfo3" data-rel="popup" data-role="button" class="ui-icon-alt" data-inline="true" data-transition="pop" data-icon="info" data-theme="g" data-iconpos="notext">Informations</a>
						<div data-role="popup" id="popupInfo3" class="ui-content" data-theme="b" style="max-width:350px;">
  							<p>La recherche se fait pour le moment dans la liste des exploitations MesParcelles</p>
						</div>
				</li>
				<li data-role="fieldcontain">
				...
				<li data-role="fieldcontain">
					<label for="norme">Type installation : </label>
					<select name="norme" id="norme" data-role="slider" data-track-theme="g" data-theme="g" onchange="()">
						<option value="ICPE">ICPE</option>
						<option value="RSD">RSD</option>
					</select>
				</li>
				<li data-role="fieldcontain">
					<fieldset data-role="controlgroup" data-type="horizontal" data-mini="true" id="f1">
		...
		<h4>Infos bâtiment</h4>		
			...
			<ul data-role="listview" data-inset="true">
				...
				<li data-role="fieldcontain">
					...
					<input type="text" name="bati_enr" id="bati_enr" value="" data-inset="true" disabled="disabled" />

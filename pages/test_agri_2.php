	...
	<div data-role="content"  id="infos">
		...
		<fieldset data-role="fieldcontain"> 
			<ul data-role="listview" data-inset="true">
				...
				<li>
				<li data-role="fieldcontain">
					<label for="octagri">Numéro Octagri </label>
					<input type="text" name="octagri" id="octagri" value="" data-inset="true"/>
				</li>
				<li data-role="fieldcontain">
					<label for="rpg">Numéro RPG </label>
					<input type="text" name="rpg" id="rpg" value="" data-inset="true"/>
				</li>
				
				<li data-role="fieldcontain">
					<fieldset data-role="controlgroup" data-type="horizontal" data-mini="true" id="f2">
    						<legend>Forme juridique :</legend>
        						<input type="radio" name="radio-choice-bb" id="radio-choice-bc" value="individuelle">
        						<label for="radio-choice-bc">Individuelle</label>
        						<input type="radio" name="radio-choice-bb" id="radio-choice-bd" value="societe">
        						<label for="radio-choice-bd">Société</label>
					</fieldset>
				...
				<li data-role="fieldcontain">
					<fieldset data-role="controlgroup" data-type="horizontal" data-mini="true" id="f2">
    						<legend>Agriculture :</legend>
        						<input type="radio" name="radio-choice-db" id="radio-choice-dc" value="conventionnelle">
        						<label for="radio-choice-dc">Conventionnelle</label>
        						<input type="radio" name="radio-choice-db" id="radio-choice-dd" value="biologique">
        						<label for="radio-choice-dd">Biologique</label>
					</fieldset>

...
<html>
    ...
    <h2>Bienvenue dans la version test de l'analyse de groupe</h2>

   <h2><font color="red"><?php echo $errorMessage; ?></font></h2>

	<img src="images/mp-logo.png" alt="Jaspersoft Logo" />

   <form action="index.php" method=POST>
	Saisir vos identifiants (ex jasperadmin/jasperadmin)<br><br>
	<table>
	<tr>
	<td>Username</td>
